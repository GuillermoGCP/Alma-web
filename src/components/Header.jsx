...
// /** Solo presentación: aquí ya NO decidimos si se oculta el header */
// function HeaderInner({ scrolled }) {
...
// /** Wrapper sin hooks “peligrosos”: decide si se muestra o no */
// const Header = ({ scrolled }) => {
//   const { pathname } = useLocation()
//   const shouldHideHeader =
//     pathname.startsWith('/admin') || pathname.startsWith('/dashboard')
//   if (shouldHideHeader) return null
//   return <HeaderInner scrolled={scrolled} />
// }
